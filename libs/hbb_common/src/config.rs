...
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("rustdesk docs home", "https://clouddesktop.com/docs/en/"),
        ("rustdesk docs x11-required", "https://clouddesktop.com/docs/en/manual/linux/#x11-required"),
        ]);
}
...
pub const RS_PUB_KEY: &str = match option_env!("RS_PUB_KEY") {
    Some(key) if !key.is_empty() => key,
    _ => "y+P949WO2Y7ihXA08RcGnzouBNQ+EUXb6zCRRNC12h8=",
};
